...
net_arg.add_argument('--cont_num', type=int, default=5)
net_arg.add_argument('--cat_num', type=int, default=5)
...
train_arg.add_argument('--q_lr', type=float, default=0.00008)
...
train_arg.add_argument('--q_step', type=int, default=2)
